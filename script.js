...
(function(window) {
    ...
    function triggerKeyEvent(charCode, eventName) {
        ...
        s.textContent = "window.slitherioTriggerKey(" + charCode + ", \"" + eventName + "\");";
        (document.head || document.documentElement).appendChild(s);
        s.parentNode.removeChild(s);
    }

    // Adds an slitherioTriggerKey method to window
    function addTriggerKeyFunction() {
        var s = document.createElement("script");
        s.textContent = "window.slitherioTriggerKey = " + function(charCode, eventName) {
    ...
    // Removes the slitherioTriggerKey method from window
    function removeTriggerKeyFunction() {
        window.slitherioTriggerKey = null;
    }
    ...
    // Stop events
    function stopNativeEvents(event){
        event.stopPropagation();
    }

    // Add window mousemove event blocker
    function addWindowMousemoveBlocker(){
        document.addEventListener("mousemove", stopNativeEvents);
    }

    // Remove window mousemove event blocker
    function removeWindowMousemoveBlocker(){
        document.removeEventListener("mousemove", stopNativeEvents);
    }
    ...
    function addLogo() {
        ...
        twitterLink.href = "https://twitter.com/home?status=I'm%20playing%20Slither.io%20with%20my%20keyboard!%0A%0AWASD%20controls%20and%20more%0A%0ATry%20Slither.io%20Ninja%20for%20Chrome!%0A%0Ahttps%3A//goo.gl/W3qqRN";
        ...
        facebookLink.href = "https://www.facebook.com/sharer/sharer.php?u=https%3A//goo.gl/W3qqRN";
        ...
        logo.id = "ninja-logo";
        logo.textContent = "Slither.io Ninja";
    ...
    function addPromo() {
        ...
        promo.textContent = "Try Agar.io Ninja now!";
    ...
    function promoClick() {
        var url = "https://chrome.google.com/webstore/detail/agario-ninja-wasd-and-mor/pbobiamfiefihckgfbppiigkfbkbmhlm";
    ...
    // Detects if the page is an slitherio client
    function detectSlitherio() {
        var output = true;
        // Conditions:
        if (
            // Has a canvas
            ...
            // Has #nbg
            !document.querySelector("#nbg") ||
            // Has #login
            !document.querySelector("#login") ||
            // Has #logo
            !document.querySelector("#logo") ||
            // Has #lastscore
            !document.querySelector("#lastscore") ||
            // Has #tips
            !document.querySelector("#tips") ||
            // Has #playh
            !document.querySelector("#playh")
        ) {
            output = false;
        }
        return output;
